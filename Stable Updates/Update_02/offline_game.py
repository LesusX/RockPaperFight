...
BG = pygame.transform.scale(pygame.image.load("assets/pixel_forest.png"), (1200, 720))
BOX = pygame.transform.scale(pygame.image.load("assets/input_box.png"), (450, 220))
BOX_B = pygame.transform.scale(pygame.image.load("assets/input_box.png"), (600, 220))
...
def main_menu_x(pl, en):
    ...
    while run:
        enemy = pygame.transform.scale(pygame.image.load(f"assets/{en}_pic.png"), (150,220))
        player = pygame.transform.scale(pygame.image.load("assets/blue_pic.png"), (150,220))
        dev_box = pygame.transform.scale(pygame.image.load("assets/black_pic.png"), (180,80))
